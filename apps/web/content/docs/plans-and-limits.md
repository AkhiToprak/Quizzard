...
description: Free, Plus, and Pro tiers — pricing, token budgets, and per-feature AI caps.
category: Account
order: 70
---
...
## Manual features are unlimited

To be explicit, on every plan including Free:

- Unlimited notebooks, sections, and pages.
- Unlimited manually-built flashcard sets and quiz sets.
- Unlimited document uploads (subject to your account storage).
- Unlimited friends, groups, exams, timers.
- The full canvas + stylus experience.

The thing the Plus and Pro upgrades buy you is **more AI**, not more notebook.

## Where to see your usage

Your account page shows your current token usage for the month, the per-feature counters, and how many days are left in the cycle. If you're regularly hitting the Free or Plus caps, that's the signal to consider upgrading.
