...
export default function PublishPage() {
  ...
  const renderStep = () => {
    switch (step) {
      case 0:
        return renderStepNotebook();
      case 1:
        return renderStepVisibility();
      case 2:
        return renderStepTitle();
      case 3:
        return renderStepContent();
      case 4:
        return renderStepTags();
      case 5:
      ...
      {loadingNotebooks ? (
        ...
        <div style={{ padding: 40, textAlign: 'center', color: COLORS.textMuted }}>
          <span
            ...
            style={{ fontSize: 36, display: 'block', marginBottom: 8, opacity: 0.4 }}
          >
            library_books
          </span>
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
                  ...
                  >
                    <span
                      className="material-symbols-outlined"
                      style={{ fontSize: 18, color: nb.color || COLORS.primaryLight }}
                    >
                      auto_stories
                    </span>
                  </div>
                  {isSelected && (
                    <span
                      className="material-symbols-outlined"
                      style={{ fontSize: 18, color: COLORS.primary, marginLeft: 'auto' }}
                    >
                      check_circle
                    </span>
                  )}
                ...
                <div style={{ fontSize: 12, color: COLORS.textMuted }}>
                  {nb.subject || 'No subject'} · {nb.sectionCount} section
                  {nb.sectionCount !== 1 ? 's' : ''}
                </div>
              </button>
            );
    ...
    const options = [
      {
        ...
        icon: 'public',
        label: 'Public',
        desc: 'Visible to everyone in the community',
      },
      {
        key: 'friends' as const,
        icon: 'group',
        label: 'Friends Only',
        desc: 'Only visible to your accepted friends',
      },
    ];
    return (
      <div>
            ...
            return (
              ...
              >
                ...
                {isSelected && (
                  <span
                    className="material-symbols-outlined"
                    style={{ fontSize: 20, color: COLORS.primary, marginLeft: 'auto' }}
                  >
                    check_circle
                  </span>
                )}
      ...
      <div style={{ maxWidth: 500 }}>
        ...
        <div
          style={{
            ...
            marginTop: 6,
            fontSize: 12,
            color: title.length >= 190 ? COLORS.error : COLORS.textMuted,
          }}
        >
          {title.length}/200
        </div>
  ...
  const renderStepContent = () => (
    <div>
      <h2 style={stepTitleStyle}>
        Content{' '}
        <span style={{ fontSize: 14, fontWeight: 400, color: COLORS.textMuted }}>(optional)</span>
      </h2>
      <p style={stepDescStyle}>
        Write a description with text, images, code blocks, and more. You can also add a cover
        image.
      </p>
  ...
  const renderStepTags = () => (
    <div>
      ...
      <p style={stepDescStyle}>
        At least one tag is required. Tags help others discover your notebook.
      </p>
      <div style={{ maxWidth: 500 }}>
        <TagInput tags={tags} onChange={setTags} maxTags={15} />
      </div>
    </div>
  );
  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', paddingBottom: 40 }}>
      ...
      {/* Stepper */}
      <div
        style={{ display: 'flex', gap: 4, marginBottom: 36, overflowX: 'auto', paddingBottom: 4 }}
      >
        {STEPS.map((s, i) => {
      ...
      {/* Step content */}
      <div style={{ minHeight: 300, marginBottom: 32 }}>{renderStep()}</div>
          ...
          <button
            ...
            style={{
              ...
              background: publishing
                ? COLORS.elevated
                : `linear-gradient(135deg, ${COLORS.primary}, #6c3ce6)`,
              color: '#fff',
              fontSize: 14,
              fontWeight: 700,
