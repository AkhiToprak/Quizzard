      ...
      html: `
        <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 520px; margin: 0 auto; padding: 40px 24px; color: #eeecff; background: #111126;">
          ...
          <p style="font-size: 16px; line-height: 1.6; margin: 0 0 24px; color: #c0bed8;">
            Thanks for signing up for the Quizzard waitlist. We'll send you an email as soon as we launch.
          </p>
        ...
        batch.map((to) => ({
          ...
          html: `
            <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 520px; margin: 0 auto; padding: 40px 24px; color: #eeecff; background: #111126;">
              ...
              <p style="font-size: 16px; line-height: 1.6; margin: 0 0 24px; color: #c0bed8;">
                The wait is over — Quizzard is now available. Head over and create your account to get started.
              </p>
              <a href="https://quizzard.app" style="display: inline-block; padding: 12px 28px; background: #ae89ff; color: #111126; font-weight: 600; text-decoration: none; border-radius: 8px;">
                Get Started
              </a>
