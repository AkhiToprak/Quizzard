...
export const PRESETS: Preset[] = [
  {
    ...
    label: 'Biology',
    color: '#4ade80',
    keywords: ['bio', 'biology', 'anatomy', 'genetics', 'ecology', 'organism', 'cell', 'botany', 'zoology'],
  ...
  },
  {
    ...
    label: 'Chemistry',
    color: '#ff7043',
    keywords: ['chem', 'chemistry', 'organic', 'reactions', 'elements', 'periodic', 'molecule', 'compound', 'acid', 'base'],
  ...
  },
  {
    ...
    label: 'Physics',
    color: '#38bdf8',
    keywords: ['phys', 'physics', 'mechanics', 'thermodynamics', 'quantum', 'electro', 'optics', 'waves', 'relativity'],
  ...
  },
  {
    ...
    label: 'Mathematics',
    color: '#ffde59',
    keywords: ['math', 'calc', 'algebra', 'geometry', 'statistics', 'trigonometry', 'calculus', 'linear', 'probability'],
  ...
  },
  {
    ...
    color: '#5170ff',
    keywords: [
      'lang', 'language', 'spanish', 'french', 'german', 'japanese', 'chinese', 'italian',
      'korean', 'portuguese', 'arabic', 'vocab', 'vocabulary', 'grammar', 'mandarin', 'russian',
      'dutch', 'swedish', 'turkish', 'hindi',
    ],
  ...
  },
  {
    ...
    label: 'History',
    color: '#a78bfa',
    keywords: ['hist', 'history', 'ancient', 'medieval', 'modern', 'civilization', 'war', 'empire', 'revolution', 'era'],
  ...
  },
  {
    ...
    label: 'Literature',
    color: '#f472b6',
    keywords: ['lit', 'literature', 'english', 'writing', 'fiction', 'poetry', 'novel', 'reading', 'essay', 'rhetoric'],
  ...
  },
  {
    ...
    color: '#8c52ff',
    keywords: [
      'cs', 'programming', 'code', 'algorithm', 'computer', 'software', 'coding', 'data structure',
      'javascript', 'python', 'typescript', 'react', 'backend', 'frontend', 'database',
    ],
